...
function Register() {
  ...
  async function handleOTP(e) {
    ...
    if (latitude === 0)
      alert(
        "Location is not enabled. Please allow location access and refresh the page."
      );
    ...
    else if (year - parseInt(dob.substring(0, 4)) < 17)
      alert("Age is too less.");
    else {
      const config = { headers: { "Content-Type": "application/json" } };
      const { data, status } = await axios.post(
        `${server}/registerWorker/verify`,
  ...
  return (
    <div className="gpt3__header section__padding" id="home">
      <div className="gpt3__header-content">
        ...
        <p>
          Sign Up on our website to get calls from organic customers and
      ...
      <div className="gpt3__header-image mybox">
        <form>
          <div className="form-group row m-2 mt-4">
            <label htmlFor="name" className="col-sm-5">
          ...
          <div className="form-group row m-2">
            <label htmlFor="contact" className="col-sm-5">
          ...
          <div className="form-group row m-2">
            <label htmlFor="dob" className="col-sm-5">
              <h5 className="text-white">Birth Date</h5>
            </label>
            <div className="col-sm-7">
              <input
                type="date"
          ...
          <div className="form-group row m-2">
            <label htmlFor="location" className="col-sm-5">
          ...
          <div className="form-group row m-2">
            <button
              className="btn btn-primary btn-md col-sm-5"
              onClick={handleOTP}
            >
              Send OTP
            </button>
          ...
          <div className="form-group row m-4">
            <button
              id="submitbutton"
              className="btn btn-primary btn-lg col-sm-5 mx-auto"
              style={{ "background-color": "green", visibility: "hidden" }}
